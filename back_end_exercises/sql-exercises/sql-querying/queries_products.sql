...
-- i combined 1,2,3 into a single comand 
...
INSERT INTO products (name,price,can_be_returned )
VALUES
('chunky_peanut_butter', '34.99', true);
...
--here is a new company policy: everything is returnable. Update the database accordingly.
